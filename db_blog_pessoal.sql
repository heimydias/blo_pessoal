...
-- -----------------------------------------------------
-- Table `db_blog_pessoal`.`tb_posta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_posta` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_posta_tb_temas_idx` (`tb_temas_id` ASC) VISIBLE,
  INDEX `fk_tb_posta_tb_usuarios1_idx` (`tb_usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_posta_tb_temas`
    FOREIGN KEY (`tb_temas_id`)
    REFERENCES `db_blog_pessoal`.`tb_temas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_posta_tb_usuarios1`
